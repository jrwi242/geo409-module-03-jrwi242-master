...
# Print the output of 7 multiplied by 56
# Assign 'OneNumber' a string value
OneNumber = '7'
# Assign 'TwoNumber' a string value
TwoNumber = 56
print('ONENumber x TwoNumber')
...
if x == 1:
    ...
    y = (250/int(x))*100 
    print("You are "+ "%" +"the height of POT!")